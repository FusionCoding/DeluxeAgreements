...
public class SQLCredentials {
  ...
  public SQLCredentials(String address, String database, String username, String password,
      int maxPoolSize, int minIdleConnections, int maxLifetime, int connectionTimeout) {
